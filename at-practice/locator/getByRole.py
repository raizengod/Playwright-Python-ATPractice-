...
class byRolePageLocators:
    ...
    """Si el label no tiene un texto único o un nombre accesible, se busca un elemento padre o un elemento cercano que sí lo tenga, y luego se encadena a un locator.
    en este caso usamos el locator CSS y el role"""
    @property
    def labeluruario(self):
        return self.page.locator("#role-locators > div > div:nth-child(2)").get_by_role("LabelText")
